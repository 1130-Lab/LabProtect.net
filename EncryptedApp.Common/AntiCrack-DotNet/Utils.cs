...
namespace AntiCrack_DotNet
{
    public sealed class Utils
    {
        ...
        public static string GetCurrentCLRModuleName()
        {
            ...
            foreach(ProcessModule module in Shared.Modules)
            {
            ...
            try
            {
                ...
                if (AsmPtr != IntPtr.Zero)
                {
                    ...
                    if (ObjectHandleOnStackType != null)
                    {
                        ...
                        Utils.CallInternalCLRFunction("GetEntryAssembly", typeof(Assembly), BindingFlags.NonPublic | BindingFlags.Static, null, new object[] { InstanceObjectHandle }, null);
                    }
                }
            }
            catch
